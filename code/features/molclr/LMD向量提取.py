...
DEFAULT_CONFIG = {
    ...
    'finetuned_weights': './ckpt/pretrained_gin/checkpoints/model.pth',
    'dataset': {
        'num_workers': 4,
        'valid_size': 0.1,
        'test_size': 0.1,
        'splitting': 'random',
        'task': 'classification',
        'data_path': './data/BC/bace.csv',
        'target': 'p_n'
    }
}
OUTPUT_VEC_FILE = 'BC_molclr_pretrain_bace.npy'
OUTPUT_SMILES_FILE = 'BC_molclr_pretrain_bace.csv'
