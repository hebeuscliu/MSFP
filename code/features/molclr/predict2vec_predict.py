...
DEFAULT_CONFIG = {
    ...
    'finetuned_weights': './finetune/Jun05_01-04-55_BC_p_n/checkpoints/model.pth',
    'dataset': {
        'num_workers': 4,
        'valid_size': 0.0,
        'test_size': 0.0,
        'splitting': 'random',
        'task': 'classification',
        'data_path': './LMD_comb2pred.csv',
        'target': 'p_n'
    }
}
OUTPUT_VEC_FILE = 'molclr_vec_predict.npy'
OUTPUT_SMILES_FILE = 'molclr_vec_predict.csv'
